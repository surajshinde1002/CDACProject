...
public class Book {
	...
	public Book(int book_id, String book_name, String book_category, String author, String publisher, int book_price,
			String book_image, String book_pdf, String description, List<IssuedBooks> issuedBooks,
			List<Request> requests) {
		super();
	...
	public String toString() {
		return "Book [book_id=" + book_id + ", book_name=" + book_name + ", book_category=" + book_category
				...
				+ book_image + ", book_pdf=" + book_pdf + ", description=" + description + ", issuedBooks="
				+ issuedBooks + ", requests=" + requests + "]";
	}
